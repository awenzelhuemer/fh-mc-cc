...
Syncronisation is only needed for all print statements to appear in order. But for the total event count calculation the barrier is not necessary and could be removed.
