...
In our case we using for ring around rosie a different tag number otherwise it could lead to problems because the receiving of a ring around rosie process is faster than the calculation.
